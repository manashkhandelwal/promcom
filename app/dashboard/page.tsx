...
export default function DashboardPage() {
    ...
    const stats = [
        { label: "Active Tasks", value: "24", icon: CheckSquare, color: "blue", trend: "+12%" },
        { label: "Team Members", value: "8", icon: Users, color: "purple", trend: "+2" },
        { label: "Completed", value: "156", icon: TrendingUp, color: "green", trend: "+23%" },
        { label: "Pending", value: "12", icon: Clock, color: "orange", trend: "-3" },
    ];

    const recentActivities = [
        { user: "Sarah Chen", action: "completed task", item: "Design Review", time: "2m ago" },
        { user: "Mike Johnson", action: "added comment on", item: "API Integration", time: "15m ago" },
        { user: "Emma Wilson", action: "created", item: "New Sprint Board", time: "1h ago" },
        { user: "David Lee", action: "updated", item: "Project Timeline", time: "2h ago" },
    ];
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            {/* Sidebar */}
            <aside
                className={`fixed top-0 left-0 h-full w-64 bg-white border-r border-gray-200 z-50 transform transition-transform duration-200 lg:translate-x-0 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
                    }`}
            >
